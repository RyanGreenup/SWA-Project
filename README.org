...
src="https://img.shields.io/badge/Contributors-5%20Member-green" /> <img src="https://img.shields.io/badge/Questions-7%20Completed-orange" /> </p>
#+END_HTML
#+begin_comment
...
** Clock Tables
*** Ryan
#+BEGIN: clocktable :scope subtree :maxlevel 6 :match "ryan"
#+CAPTION: Ryan's Clock summary at [2020-04-29 Wed 08:28]
| Headline                                       | Time      |         |      |
|------------------------------------------------+-----------+---------+------|
| *Total time*                                   | *1d 1:19* |         |      |
|------------------------------------------------+-----------+---------+------|
...
#+END:
*** Navid
#+BEGIN: clocktable :scope subtree :maxlevel 6 :match "navid"
#+CAPTION: Navid's Clock summary at [2020-04-29 Wed 08:28]
| Headline     | Time   |
|--------------+--------|
| *Total time* | *0:00* |
#+END:
...
*** Hassan
#+BEGIN: clocktable :scope subtree :maxlevel 6 :match "hassan"
#+CAPTION: Hassan's Clock summary at [2020-04-29 Wed 08:28]
| Headline     | Time   |
|--------------+--------|
| *Total time* | *0:00* |
#+END:
*** Kieran
#+BEGIN: clocktable :scope subtree :maxlevel 6 :match "kieran"
#+CAPTION: Kieran's Clock summary at [2020-04-29 Wed 08:28]
| Headline     | Time   |
|--------------+--------|
| *Total time* | *0:00* |
#+END:
...
:LOGBOOK:
CLOCK: [2020-04-29 Wed 08:23]
:END:
*** TODO 9 Find Unique users who have $\leq$ average friend counts            :ryan:
*** TODO 10 Combine tweets of users identified in 8/9                         :ryan:
*** TODO 11 Clean and pre-process the tweet text data
*** TODO 12 Display the first two tweets                                      :Keiran:
*** TODO Create a TDM, use TFIDF, how many tweets were empty?                 :ryan:
*** TODO 14 Cluster the Results with respect to cosine distance               :ryan:
