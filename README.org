...
#+CAPTION: Clock summary at [2020-05-04 Mon 15:23]
| Headline                                       | Time       |         |       |
|------------------------------------------------+------------+---------+-------|
| *Total time*                                   | *1d 21:07* |         |       |
|------------------------------------------------+------------+---------+-------|
...
| \_    Create a TDM, use TFIDF, how many...     |            |         |  3:35 |
| \_    14 Cluster the Results with respect...   |            |         | 12:16 |
| \_    15 Count the Number of Clusters          |            |         |  0:40 |
#+END:
*** Navid
...
*** REPORT 16 Visualise in 2 Dimensions
:LOGBOOK:
