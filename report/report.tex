...
\end{minted}
\caption{\label{orgfec06b8}Load the Packages for \textbf{\textbf{\emph{R}}}}
\end{listing}
...
##   588.4189 10228.7352
\end{minted}
\caption{\label{orgb0e125b}Confidence Interval of Mean Follower Count in Population}
\end{listing}
