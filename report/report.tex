...
\end{minted}
\caption{\label{org0316cf1}Load the Packages for \textbf{\textbf{\emph{R}}}}
\end{listing}
...
##   588.4189 10228.7352
\end{minted}
\caption{\label{org688d57a}Confidence Interval of Mean Follower Count in Population}
\end{listing}
...
chi_obs <- sum((e-o)^2/e)
\end{minted}
\caption{\label{org8068990}Calculate Expected frequency of values under the assumption of independence.}
\end{listing}
...
## [1] 4e-04
\end{minted}
\caption{\label{orga4f02a8}Performing a \(\chi^{2}\) statistic from first principles}
\end{listing}
\end{enumerate}
\end{enumerate}
\subsubsection{{\bfseries\sffamily FIXME} Conclusion}
\label{sec:org997e2cb}
...
\end{minted}
\caption{\label{org4fe73b0}Load the Packages for \textbf{\textbf{\emph{R}}}}
\end{listing}

\subsection{8.2.13 Create a Term Document Matrix}
\label{sec:orgb63a473}
...
\end{minted}
\caption{\label{orgc418026}Create a plot of the distribution of Friends among Clusters as shown in figure \ref{fig:org03d7faa}}
\end{listing}
...
\end{minted}
\caption{\label{org3f49df2}Create a plot of the distribution of Friends Count Status as shown in figure \ref{fig:org3896f2b}}
\end{listing}

\begin{figure}[htbp]
\centering
\includegraphics[width=9cm]{./Figures/betclustplot8216.png}
\caption{\label{fig:org03d7faa}Distribution of Friend Count Status over Clusters}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=9cm]{./Figures/betfriendplot8216.png}
\caption{\label{fig:org3896f2b}Distribution of Friend Count Status}
\end{figure}
...
\caption{\label{fig:orgbfac2e6}Wordcloud of Cluster \texttt{\#} 1 using \emph{TF-IDF} weighting}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=14cm]{./Figures/Cluster2Cloud.png}
\caption{\label{fig:orgdc56e83}Wordcloud of Cluster \texttt{\#} 2 using \emph{TF-IDF} weighting}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=10cm]{./Figures/Cluster3Cloud.png}
\caption{\label{fig:org867b0e0}Wordcloud of Cluster \texttt{\#} 3 using \emph{TF-IDF} weighting}
\end{figure}
...
\label{sec:org00d9e86}
\begin{table}[htbp]
\caption{\label{tab:org4b93ec8}User ID and Friend Count of users with above highest friend count in sample}
\centering
\begin{tabular}{rr}
\textbf{\emph{User ID}} & \textbf{\emph{Friend Count}}\\
\hline
...
\label{sec:org1204203}

\begin{table}[htbp]
\caption{\label{tab:org4cc3ccb}Document Term Matrix of first 6 documents and first 6 Words}
\centering
...
\label{sec:orgd91ae8c}
\begin{figure}[htbp]
\centering
\includegraphics[width=7cm]{./Figures/lisp_cycles.png}
\caption{\label{fig:org03a6978}\emph{xkcd} \texttt{\#} 297}
\end{figure}
\end{document}
