...
\end{minted}
\caption{\label{org1bf1f36}Load the Packages for \textbf{\textbf{\emph{R}}}}
\end{listing}
...
##   588.4189 10228.7352
\end{minted}
\caption{\label{org5bda8cf}Confidence Interval of Mean Follower Count in Population}
\end{listing}
...
chi_obs <- sum((e-o)^2/e)
\end{minted}
\caption{\label{org41a1c50}Calculate Expected frequency of values under the assumption of independence.}
\end{listing}
...
## [1] 4e-04
\end{minted}
\caption{\label{org7b3abe0}Performing a \(\chi^{2}\) statistic from first principles}
\end{listing}
\end{enumerate}
\end{enumerate}
\subsubsection{{\bfseries\sffamily FIXME} Conclusion}
\label{sec:org22a7af4}
...
\end{minted}
\caption{\label{org154ef34}Load the Packages for \textbf{\textbf{\emph{R}}}}
\end{listing}

\subsection{8.2.13 Create a Term Document Matrix}
\label{sec:org3f16bd2}
...
\end{minted}
\caption{\label{org173bb59}Create a plot of the distribution of Friends among Clusters as shown in figure \ref{fig:org06f92be}}
\end{listing}
...
\end{minted}
\caption{\label{org3fa94ea}Create a plot of the distribution of Friends Count Status as shown in figure \ref{fig:orgeb113fc}}
\end{listing}

\begin{figure}[htbp]
\centering
\includegraphics[width=9cm]{./Figures/betclustplot8216.png}
\caption{\label{fig:org06f92be}Distribution of Friend Count Status over Clusters}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=9cm]{./Figures/betfriendplot8216.png}
\caption{\label{fig:orgeb113fc}Distribution of Friend Count Status}
\end{figure}
...
\end{minted}
\caption{\label{org8a2f03a}Create a dendrogram of the terms in the cluster with the higest friends count, average linkage was used.}
\end{listing}
...
\end{minted}
\caption{\label{org239612a}Create a dendrogram of the terms in the cluster with the higest friends count, average linkage was used.}
\end{listing}
...
\caption{\label{fig:org92641b1}Dendrogram of Terms in the cluster with the highest friend count using average Linkage.}
\end{figure}
...
\label{sec:orga06dfc1}
\begin{table}[htbp]
\caption{\label{tab:org9f7ca9f}User ID and Friend Count of users with above highest friend count in sample}
\centering
\begin{tabular}{rr}
\textbf{\emph{User ID}} & \textbf{\emph{Friend Count}}\\
\hline
...
\label{sec:org062860e}

\begin{table}[htbp]
\caption{\label{tab:orge5db9c8}Document Term Matrix of first 6 documents and first 6 Words}
\centering
...
\label{sec:org68fc343}
\begin{figure}[htbp]
\centering
\includegraphics[width=7cm]{./Figures/lisp_cycles.png}
\caption{\label{fig:orgb3367f7}\emph{xkcd} \texttt{\#} 297}
\end{figure}
\end{document}
