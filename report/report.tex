...
\end{minted}
\caption{\label{orgd656b0f}Load the Packages for \textbf{\textbf{\emph{R}}}}
\end{listing}
...
##   588.4189 10228.7352
\end{minted}
\caption{\label{org5dce4b3}Confidence Interval of Mean Follower Count in Population}
\end{listing}
...
chi_obs <- sum((e-o)^2/e)
\end{minted}
\caption{\label{orge9c203d}Calculate Expected frequency of values under the assumption of independence.}
\end{listing}
...
## [1] 4e-04
\end{minted}
\caption{\label{org7cc5973}Performing a \(\chi^{2}\) statistic from first principles}
\end{listing}
\end{enumerate}
\end{enumerate}
\subsubsection{{\bfseries\sffamily FIXME} Conclusion}
\label{sec:org4293b5d}
...
\end{minted}
\caption{\label{org15087c8}Load the Packages for \textbf{\textbf{\emph{R}}}}
\end{listing}

\subsection{8.2.13 Create a Term Document Matrix}
\label{sec:org167189c}
...
\end{minted}
\caption{\label{org9ce1446}Create a plot of the distribution of Friends among Clusters as shown in figure \ref{fig:orga86d4a4}}
\end{listing}
...
\end{minted}
\caption{\label{org5cb5971}Create a plot of the distribution of Friends Count Status as shown in figure \ref{fig:orgdcdc168}}
\end{listing}

\begin{figure}[htbp]
\centering
\includegraphics[width=9cm]{./Figures/betclustplot8216.png}
\caption{\label{fig:orga86d4a4}Distribution of Friend Count Status over Clusters}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=9cm]{./Figures/betfriendplot8216.png}
\caption{\label{fig:orgdcdc168}Distribution of Friend Count Status}
\end{figure}
...
\end{minted}
\caption{\label{orgd88bf19}Create a dendrogram of the terms in the cluster with the higest friends count, average linkage was used.}
\end{listing}
...
\end{minted}
\caption{\label{orge28cadc}Create a dendrogram of the terms in the cluster with the higest friends count, average linkage was used.}
\end{listing}
...
\caption{\label{fig:orgf651316}Dendrogram of Terms in the cluster with the highest friend count using average Linkage.}
\end{figure}
...
\label{sec:org789f5a6}
\begin{table}[htbp]
\caption{\label{tab:orgfd7a833}User ID and Friend Count of users with above highest friend count in sample}
\centering
\begin{tabular}{rr}
\textbf{\emph{User ID}} & \textbf{\emph{Friend Count}}\\
\hline
...
\label{sec:org74d6553}

\begin{table}[htbp]
\caption{\label{tab:org3d9def0}Document Term Matrix of first 6 documents and first 6 Words}
\centering
...
\label{sec:org9299bda}
\begin{figure}[htbp]
\centering
\includegraphics[width=7cm]{./Figures/lisp_cycles.png}
\caption{\label{fig:orgbde0143}\emph{xkcd} \texttt{\#} 297}
\end{figure}
\end{document}
