...
+ Discussion about upcoming titles
  + For example the /Sunborn-Ubisoft/ collaboration
    + This is where the use of =collab= comes from
  + The upcoming /Division 2/ release
+ Multiplayer games as inferred from the use of words like
  + being banned
  + complaining (i.e. whining)
  + Collab
...
+ Console games as inferred from the use of =crossplay=
  +
