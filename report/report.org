...
The clusters can be projected into 2D /Euclidean/-Space using /Multi-Dimensional Scaling/, these dimensions would represent the first two principle components of the cosine distance of the weigted tweets. This is demonstrated in listings [[cmds]].
